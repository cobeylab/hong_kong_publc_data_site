#
# R syntax to reproduce information for Table S1 from:
#
...
for(i in 1:m){dat.nomiss[[i]] <- dat.nomiss[[i]][dat.nomiss[[i]]$intervention=="TIV",]}
dat <- dat[dat$intervention=="TIV",]
